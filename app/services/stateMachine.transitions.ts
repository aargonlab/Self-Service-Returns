...
export function getTransitionEventName(
  ...
  const eventMap: Record<string, string> = {
    ...
    "APPROVED->REJECTED": "Return rejected (intermediate states skipped via API)",
    "AWAITING_SHIPMENT->REJECTED": "Return rejected (intermediate states skipped via API)",
    "IN_TRANSIT->REJECTED": "Return rejected (intermediate states skipped via API)",
